...
<div>
    ...
    <div className='review-slider-bg'>
    ...
    <div className='review-slider-flex container'>
        
        <div className="review-slider">

            <img src={reviews[currentIndex]} alt={`Slide ${currentIndex + 1}`} />
        ...
        <div className='review-slider-right'>
